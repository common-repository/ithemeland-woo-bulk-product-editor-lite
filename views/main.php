            ...
            <div class="wcbef-tabs-navigation">
                <nav class="wcbef-tabs-navbar">
                    <ul class="wcbef-tabs-list" data-content-id="wcbef-main-tabs-contents">
                        <li>
                            <a class="wcbef-ml45 <?php echo (isset($current_tab) && ($current_tab == 'bulk-edit')) ? 'selected' : '' ?>" data-content="bulk-edit" data-type="main-tab" href="#" <?php echo (!isset($is_active) || $is_active === false) ? "data-disabled='true'" : "data-disabled='false'"; ?>><?php esc_html_e('Bulk Edit', 'woocommerce-bulk-edit-free'); ?></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a data-content="activation" href="#" data-type="main-tab" class="<?php echo (isset($current_tab) && ($current_tab == 'activation')) ? 'selected' : ''; ?>">
                                <?php esc_html_e('Activation', 'woocommerce-bulk-edit-free'); ?>
                            </a>
                        </li>
                    </ul>
                </nav>
