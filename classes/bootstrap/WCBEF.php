...
class WCBEF
{
    ...
    {
        add_menu_page(esc_html__('iT Woo Products', 'woocommerce-bulk-edit-free'), sprintf('%s', '<span style="color: #627ddd;font-weight: 900;">iT</span> Woo Products'), 'manage_woocommerce', 'wcbef', [new Woocommerce_Bulk_Edit_Free(), 'index'], WCBEF_IMAGES_URL . 'wcbef_icon.svg', 2);
    }
